...
async function inject() {
  console.log('--- Phase 6.1: High-Density Narrative Injection ---');
  ...
  if (pError) {
    console.error('Project Update Error:', pError);
    return;
  }
  ...
  if (cError) {
    console.error('Characters Sync Error:', cError);
  } else {
    console.log('✔ 8 Characters Injected');
  }
