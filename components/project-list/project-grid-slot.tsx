...
export function ProjectGridSlot({ className }: { className?: string }) {
  return (
    <Link 
      href="/project-wizard"
      className={cn("relative flex flex-col items-center justify-center h-[325px] w-full rounded-[20px] bg-black/40 border border-white/5 border-dashed hover:border-brand-gold/40 hover:bg-white/5 transition-all group overflow-hidden", className)}
    >
